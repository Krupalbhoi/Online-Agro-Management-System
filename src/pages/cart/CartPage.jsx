...
const CartPage = () => {
    ...
    const buyNowFunction = () => {
        ...
        const validatePhoneNumber = (phoneNumber) => {
            const phoneRegex = /^[6-9]\d{9}$/; // Regular expression for a valid Indian mobile number
            return phoneRegex.test(phoneNumber);
        };
    
        if (!validatePhoneNumber(addressInfo.mobileNumber)) {
                            ...
                            <div>
                                <dl className=" space-y-1 px-2 py-4">
                                    ...
                                    <div className="flex items-center justify-between border-y border-dashed py-4 ">
                                        ...
                                        <dd className="text-base font-medium text-gray-900">₹ {cartTotal +  100} </dd>
                                    </div>
                                </dl>
