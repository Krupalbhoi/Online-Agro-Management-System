                                            ...
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-green-100 md:flex-row">
                                                ...
                                                <div className="w-full border-r border-green-100 bg-green-50 md:max-w-xs">
                                                    ...
                                                    <div className="p-8">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            ...
                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold">Paymant Mode :</div>
                                                                <div className="text-sm font-medium text-green-800 first-letter:uppercase">Cash On Delivery</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-1">
                                                    <div className="p-8">
                                                        ...
                                                        <button className='bg-green-500 mt-4 hover:bg-green-600 w-full text-white text-center py-2 font-bold rounded-md ' onClick={()=> orderDelete(order.id)}>Cancel</button>
